...
namespace Perfi.Infrastructure.Migrations
{
    ...
    [Migration("20221228213809_AddIncomeDocumentIncomeSourceAndRemoveJob")]
    partial class AddIncomeDocumentIncomeSourceAndRemoveJob
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Perfi.Core.Earnings.IncomePaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("IncomePaymentMethod", (string)null);
            ...
            modelBuilder.Entity("Perfi.Core.Earnings.CashAccountIncomePaymentMethod", b =>
                {
                    b.HasBaseType("Perfi.Core.Earnings.IncomePaymentMethod");
                    ...
                    b.ToTable("CashAccountIncomePaymentMethod", (string)null);
                });
            ...
            modelBuilder.Entity("Perfi.Core.Earnings.IncomePaymentMethod", b =>
                {
                    b.HasOne("Perfi.Core.Earnings.IncomeDocument", null)
                        ...
                        .HasForeignKey("Perfi.Core.Earnings.IncomePaymentMethod", "Id")
            ...
            modelBuilder.Entity("Perfi.Core.Earnings.CashAccountIncomePaymentMethod", b =>
                {
                    b.HasOne("Perfi.Core.Earnings.IncomePaymentMethod", null)
                        .WithOne()
                        .HasForeignKey("Perfi.Core.Earnings.CashAccountIncomePaymentMethod", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
