...
namespace Perfi.Infrastructure.Migrations
{
    ...
    [Migration("20230127150157_SeedIncomeSourceSummaryAccount")]
    partial class SeedIncomeSourceSummaryAccount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Perfi.Core.MoneyTransfers.MoneyTransfer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Perfi.Core.MoneyTransfers.MoneyTransfer", b =>
                {
                    b.OwnsOne("Perfi.Core.Accounting.Money", "Amount", b1 =>
                        {
                            b1.Property<int>("MoneyTransferId")
                                .HasColumnType("integer");
                            ...
                            b1.HasKey("MoneyTransferId");

                            b1.ToTable("MoneyTransfer");
